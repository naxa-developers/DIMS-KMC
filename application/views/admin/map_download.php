    ...
    <!-- page start-->
        ...
        <div class="col-sm-12">
            <section class="panel">
              <section class="panel">
                  <header class="panel-heading">
                     <b><?php echo $this->lang->line('map_download'); ?></b>
                  
                      <span class="tools pull-right">
                        <a href="<?php echo base_url()?>add_maps"><button type="submit" name="upload_data" class="btn btn-danger" style="background-color: #1fb5ad;border-color: #1fb5ad;margin-top: -7px;"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_maps'); ?></button></a>
                       </span>
                  </header>
            ...
            echo '<td><button type="button" class="btn btn-round btn-danger" data-toggle="modal" data-target="#myModal'.$v['id'].'"> change  Photo</button></td>';
                            ...
                            <?php }}  ?>
                              <td>
                                <a href="<?php echo base_url()?>edit_map?id=<?php echo base64_encode($v['id']);?> "><?php echo $this->lang->line('edit'); ?></a> /
                                <a onclick="return confirm('Are you sure you want to delete?')" href="<?php echo base_url()?>delete_map?id=<?php echo $v['id'];?>"><?php echo $this->lang->line('delete'); ?></a></td>
