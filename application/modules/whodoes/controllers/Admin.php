  	...
  	public function add_organisation(){
		...
		if ($this->form_validation->run() == TRUE){
	      ...
	      //admin check
	    	...
	    	//print_r($id);die;
	    	if($id) {
				$this->data['drrdataeditdata'] = $this->general->get_tbl_data_result('id,name','organisation',array('id'=>$id));
	    	}else{
	    		$this->data['drrdataeditdata'] = array();	
	    	}
	    	$this->data['publicationdata'] = $this->general->get_tbl_data_result('id,name','organisation');	
	      	$admin_type=$this->session->userdata('user_type');
