            ...
            <form role="form"  method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group ">
                  <div class="col-sm-4">
                    ...
                    <input type="text" name="name" class="form-control" id="name" value="<?php echo !empty($drrdataeditdata[0]['name'])?$drrdataeditdata[0]['name']:'' ?>" placeholder="User Name Or Email">
                    <?php echo form_error('name'); ?>
                  </div>
                  <div class="col-sm-4">
                     <label for="name">Create Password: </label>
                     <input type="password" name="password" class="form-control" id="password" value="<?php echo !empty($drrdataeditdata[0]['name'])?$drrdataeditdata[0]['name']:'' ?>" placeholder="CREATE PASSWORD">
                    <?php echo form_error('name'); ?>
                  </div>
                  <div class="col-sm-4">
                     <label for="name">Re Enter Password: </label>
                     <input type="password" name="password" class="form-control" id="password" value="<?php echo !empty($drrdataeditdata[0]['password'])?$drrdataeditdata[0]['password']:'' ?>" placeholder="RE ENTER PASSWORD">
                    <?php echo form_error('name'); ?>
                  </div>
                </div>
