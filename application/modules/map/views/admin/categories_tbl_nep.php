...
<!--              Categories Nepali-->
              ...
              <span class="tools pull-right">
                ...
                <a href="<?php echo base_url(FOLDER_ADMIN)?>/map/admin_category?tbl=" target="_blank"><button type="submit" name="upload_data" class="btn btn-danger" style="background-color: #1fb5ad;border-color: #1fb5ad;margin-top: -7px;"><i class="fa fa-map-marker"></i> <?php echo $this->lang->line('view_in_map'); ?></button></a>
      ...
      <a class="nav-link" href="<?php echo base_url(FOLDER_ADMIN);?>/map/categories_tbl/nep"><img src="<?php echo base_url();?>assets/img/nep.png" height="15"></a>
