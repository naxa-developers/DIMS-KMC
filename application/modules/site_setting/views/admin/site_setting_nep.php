          ...
          <div class="panel-body">
              ...
              <div class="panel panel-success class">
                ...
                <div class="panel-body space">
                  ...
                  <form method="post" action ="<?php echo base_url(FOLDER_ADMIN); ?>/site_setting/update_cover_nep" enctype="multipart/form-data" >
              ...
              <div class="panel panel-danger class">
                ...
                <div class="panel-body space ">
                  <div class="row">
                      <form method="POST" action="<?php echo base_url(FOLDER_ADMIN); ?>/site_setting/important_link_nep">
                    <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="panel panel-info class">
                                  <form method="POST" action="<?php echo base_url(FOLDER_ADMIN); ?>/site_setting/find_us_links_nep">
                                <div class="panel-heading">
                                Find us links
                                </div>
                                <div class="panel-body space">
                              ...
                              <div class="panel panel-warning class">
                                  <form method="POST" action="<?php echo base_url(FOLDER_ADMIN); ?>/site_setting/copyright_nep">
                                <div class="panel-heading">
                                  Copy right Text
                                </div>
                                <div class="panel-body space">
