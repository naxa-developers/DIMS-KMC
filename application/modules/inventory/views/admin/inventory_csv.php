                  ...
                  <header class="panel-heading">
                     <b><?php //echo $name ?>Inventory Category</b>
                      <span class="tools pull-right">
                        <a href="<?php echo base_url(FOLDER_ADMIN)?>/csvtable/upload_inventory_data"><button type="submit" name="upload_data" class="btn btn-danger" style="background-color: #1fb5ad;border-color: #1fb5ad;margin-top: -7px;"><i class="fa fa-plus"></i><?php echo $this->lang->line('upload_csv'); ?></button></a>
                        </span>
                  </header>
