                ...
                <strong>Message!!!!</strong>  <?php echo $error ; ?>
                    ...
                    <?php }else{ ?>
                      <table class="table table-hover" id='tb1'>
                          ...
                          <a onclick="return confirm('Are you sure you want to delete?')" href="<?php echo base_url(FOLDER_ADMIN)?>/report/delete?id=<?php echo  $v['id'];?>"><?php echo $this->lang->line('delete'); ?></a>
