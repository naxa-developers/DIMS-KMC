  ...
  <nav class="navbar navbar-expand-sm">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="report_page"><i class="fa fa-map" aria-hidden="true"></i> <?php echo !empty(MAP)?MAP:'' ?></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="map_reports"><i class="fa fa-database" aria-hidden="true"></i> <?php echo !empty(DATA)?DATA:'' ?></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="map_reports_table"><i class="fa fa-pencil-square" aria-hidden="true"></i> <?php echo !empty(GHATANA_BIB)?GHATANA_BIB:'' ?></a>
      </li>
    </ul>
  </nav>
</div>
...
<form  method="POST" action="">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="p-4">
        <div class="row">
              <div class="col-md-9"><h4 class="text-uppercase m-0"><strong><?php echo !empty(INCIDENT_DETAIL)?INCIDENT_DETAIL:'' ?></strong></h4></div>
              <div class="col-md-3 clearfix">
                <a class="btn btn-primary btn-sm pull-right" href="ReportController/ghatana_download?qry=<?php echo $query ?>"><i class="fa fa-cloud-download"></i> <?php echo !empty(DOWNLOAD)?DOWNLOAD:'' ?> </a>
              </div>
        </div>
      </div>
  </div>
...
-->
        ...
        <div class="col-md-2">
          <button type="submit" name="submit" class="btn btn-primary hit btn-block mt-4"><?php echo !empty(APPLY)?APPLY:''?></button>
        </div>
    </div>
  </div>
</div>
